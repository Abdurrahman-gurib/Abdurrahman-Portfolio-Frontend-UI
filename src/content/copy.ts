...
export const COPY = {
  nav: {
    ...
    cta: 'Request a quote',
    /** Section labels used for eyebrows on the home page. */
    index: [
  ...
  pricing: {
    ...
    /** Group headings on the sheet; the eyebrow carries the group name, so the h2 says what the group covers. */
    groupTitles: {
  ...
  contact: {
    ...
    budgets: [
      'Under MUR 15,000',
      'MUR 15,000 to 30,000',
      'MUR 30,000 to 60,000',
      'MUR 60,000 to 120,000',
      'Over MUR 120,000',
      'Not sure yet',
    ],
  ...
  /** Live chat: the floating widget on the public site and the Messages pages in the back office. */
  chat: {
    launcherOpen: 'Chat with me',
    launcherClose: 'Close chat',
    unreadHint: 'New reply',
    dialogLabel: 'Chat with Abdurrahman Gurib',
    ownerName: 'Abdurrahman Gurib',
    ownerShort: 'Abdurrahman',
    assistant: 'Assistant',
    you: 'You',
    tagline: 'Usually replies within one business day',
    close: 'Close',
    intro: 'Leave your name and email so I can get back to you, then tell me what you need. I read every message myself.',
    fields: {
      name: 'Your name',
      ...
      messagePlaceholder: 'A line or two about your business and what you need.',
    },
    validation: {
      name: 'Enter your name, at least two characters.',
      email: 'Enter an email address I can reply to.',
      message: 'Write a short message, at least two characters.',
    },
    start: 'Start',
    starting: 'Starting…',
    composerLabel: 'Write a message',
    composerPlaceholder: 'Write a message. Enter sends, Shift and Enter adds a line.',
    send: 'Send',
    sending: 'Sending…',
    loadingThread: 'Loading your conversation',
    sendFailed: 'The message was not sent. Try again.',
    startFailed: 'The chat could not start. Try again, or message me on WhatsApp.',
    closedNote: 'This conversation has been closed. Start a new one if you have another question.',
    goneNote: 'That conversation is no longer available. You can start a new one below.',
    emailFollowUp: 'If you leave the page, I reply by email.',
    newConversation: 'Start a new conversation',
    confirmNew: 'Start a new conversation? The current one will no longer be shown here.',
    whatsapp: 'Prefer WhatsApp?',
    whatsappMessage: 'Hello Abdurrahman, I was on your website and would like to ask about a project.',
    /** Back-office Messages pages. */
    backoffice: {
      nav: 'Messages',
      title: 'Messages',
      unreadLabel: 'unread',
      unreadLine: 'Unread chat messages: {count}',
      ...
      emptyBody: 'Visitors who use the chat on the site appear here.',
      emptyFilteredTitle: 'Nothing here.',
      emptyFilteredBody: 'There are no conversations with this status.',
      showing: 'Showing {from} to {to} of {total}',
      previous: 'Previous',
      next: 'Next',
      allConversations: 'All conversations',
      notFoundTitle: 'Conversation not found.',
      notFound: 'That conversation does not exist or has been deleted.',
      started: 'Started',
      page: 'Page',
      ...
      deleting: 'Deleting…',
      confirmDelete: 'Delete the conversation with {name}? This cannot be undone.',
      thread: 'Conversation',
      noMessages: 'No messages yet.',
      replyLabel: 'Reply',
      replyPlaceholder: 'Write your reply. Enter sends, Shift and Enter adds a line.',
      replyNote: 'The visitor sees the reply in the chat, and also receives it by email when SMTP is configured.',
      send: 'Send reply',
      sending: 'Sending…',
      replyFailed: 'The reply was not sent. Try again.',
      closedReplyNote: 'This conversation is closed. Reopen it to reply.',
      senders: { visitor: 'Visitor', owner: 'You', bot: 'Assistant' },
    },
  },
};
